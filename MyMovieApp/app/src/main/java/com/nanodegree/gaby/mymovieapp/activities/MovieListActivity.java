...
public class MovieListActivity extends AppCompatActivity
    ...
    @Override
    public void onMovieSelected(MovieResponse movieSelected) {
        if (mTwoPane) {
            // In two-pane mode, show the detail view in this activity by
            // adding or replacing the detail fragment using a
            // fragment transaction.
            Bundle arguments = new Bundle();
            arguments.putParcelable(MovieDetailFragment.ARG_ITEM_ID, movieSelected);
            ...
            detailIntent.putExtra(MovieDetailFragment.ARG_ITEM_ID, movieSelected);
